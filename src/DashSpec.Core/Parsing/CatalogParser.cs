...
public static class CatalogParser
{
    public static CatalogDocument Parse(string text)
    {
        ...
        return new CatalogDocument(catalogId, defaultEntryId, entries);
    }
    ...
    private static CatalogEntryDefinition ParseEntry(TokenReader reader)
    {
        ...
        reader.SkipNewlines();
        return new CatalogEntryDefinition(id, title, dashspecPath);
    }
}
