...
internal sealed class ToggleMatrixAxisLabelsXCommand : PlatformCommand<DashboardFilterContext>
{
    public const string Id = "dash.card.matrix.axis_x.toggle";
    ...
    protected override CommandOutcome Execute(DashboardFilterContext context)
    {
        ...
        context.PendingCardActionId = "toggle_matrix_axis_labels_x";
